...
In questa fase si da piena fiducia all'utilizzatore sulla correttezza dei dati inseriti e sull'attività svolta.
...
Il tempo utile per per la preparazione è settabile dall'utente tra le impostazioni dell'applicazione, invece il tempo di 
