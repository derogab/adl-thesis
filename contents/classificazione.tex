...
Nel nostro caso l'insieme di queste informazioni è contenuto nei file con i valori ricevuti dall'applicazione.
...
\end{itemize}
Come si può notare i valori contenuti in un singolo record corrispondono a quelli inviati dall'applicazione 
in un messaggio durante la raccolta dei dati di apprendimento,
eccezion fatta per il tipo di sensore già utilizzato per la divisione preliminare.
...
\begin{figure}[H]
    \centering
    \includesvg[scale = 0.8]{assets/graphs/create_segments.svg}
