...
Nel nostro caso l'insieme di queste informazioni è contenuto nei file CSV nei quali sono salvati i dati ricevuti dall'applicazione.
...
inviati dall'applicazione in un singolo messaggio durante l'apprendimento,
