...
REST (\textit{Representational State Transfer}) è uno stile architetturale. 
...
deve saper rispondere con i dati e le modalità che ci si aspetta.
...
connessione al \textit{modulo di comunicazione} avviene via socket mediante TCP. 
